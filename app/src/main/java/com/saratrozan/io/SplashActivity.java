...
public class SplashActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        configSplash.setAnimLogoSplashTechnique(Techniques.TakingOff); //choose one form Techniques (ref: https://github.com/daimajia/AndroidViewAnimations)
      ...
      //  configSplash.setPathSplash(SyncStateContract.Constants.DROID_LOGO); //set path String
        ...
        //Customize Title
        configSplash.setTitleSplash("ERP Elastomers");
